...
namespace Unity.InteractiveTutorials
{
    public class PrefabInstanceCountCriterion : Criterion
    {
        ...
        protected override bool EvaluateCompletion()
        {
            ...
            var matches = FindObjectsOfType<GameObject>().Where(go => PrefabUtility.GetPrefabParent(go) == prefabParent);
        ...
        {
            var prefabInstances = FindObjectsOfType<GameObject>().Where(go => PrefabUtility.GetPrefabParent(go) == prefabParent);
